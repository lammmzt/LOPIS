                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a href="#" class="btn btn-primary shadow btn-xs sharp me-1" data-bs-toggle="modal" id=<?= $data['id_kecamatan']; ?> data-bs-target="#editModal"><i class="fas fa-pencil-alt"></i></a>
                                        <a href="#" class="btn btn-danger shadow btn-xs sharp" data-bs-toggle="modal" data-bs-target="#hapusModal<?= $data['id_kecamatan']; ?>"><i class="fa fa-trash"></i></a>
                                    </div>
                                </td>
                            </tr>
                ...
                <div class="modal-body">
                    <div class="basic-form">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="Masukan nama kecamatan" name="name" id="name" required>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    <div class="basic-form">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="Masukan nama kecamatan" name="name" id="edit_nama_kec" value="" required>
                            </div>
                        </div>
                    </div>
...
?>
    <!-- modal hapus -->
    <div class="modal fade bd-example-modal-sm" tabindex="-1" role="dialog" aria-hidden="true" id="hapusModal<?= $data['id_kecamatan']; ?>">
