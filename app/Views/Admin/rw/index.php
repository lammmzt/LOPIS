                            ...
                            <td>
                                <div class="d-flex">
                                    <a href="#" class="btn btn-primary shadow btn-xs sharp me-1" data-bs-toggle="modal"
                                        data-bs-target="#edit<?= $data['id_rw']; ?>"><i
                                            class="fas fa-pencil-alt"></i></a>
                                    <a href="#" class="btn btn-danger shadow btn-xs sharp" data-bs-toggle="modal"
                                        data-bs-target="#hapus<?= $data['id_rw']; ?>"><i class="fa fa-trash"></i></a>
                                </div>
                            </td>
                        </tr>
                ...
                <div class="modal-body">
                    <div class="basic-form">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="Masukan No rw" name="name"
                                    id="name">
                            </div>
                        </div>
                    </div>
